...
let change = [
 /* { name: 'twenties-output', value: 2000, count: 0, imageUrl: "" },
    { name: 'tens-output',     value: 1000, count: 0, imageUrl: "" },
    { name: 'fives-output',    value: 500,  count: 0, imageUrl: "" },
